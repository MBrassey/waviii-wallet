...
import waviiiLogo from "../../src/assets/img/waviii-wallet.png";
...
class App extends React.Component {
  ...
  async loadBlockchainData() {
    if (this.state.loading) {
      ...
      const TokenAddress = "0x9cc6754d16b98a32ec9137df6453ba84597b9965"; // Official waviii Token Contract Address
      // const TokenAddress = "0xBA00868912Af1a409F11E9c2B5d3a9376Cb3C2E2"; // waviii2 Contract Address
            ...
            <Col md="12">
              <Card>
                <CardHeader>
                  ...
                  >
                    <span>
                      <center>{this.state.account}</center>
                    </span>
                  </a>
                </CardHeader>
